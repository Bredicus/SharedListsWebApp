                ...
                <?php 
                    ...
                    if (is_array($data) && !empty($data)) { 
                        ...
                        foreach($data['lists'] as $list) {
                            ...
                            if ($list->bookmarked) {
                                echo "<td>
                                <a href='/public/list/setBookmark/$list->list_id/1/0' class='btn btn-default'>&#11088;</a>
                                <a href='/public/list/display/$list->list_id' class='btn btn-success'>View</a>
                                <a href='/public/list/leave/$list->list_id/0' class='btn btn-danger'>Leave</a>
                                </td>";
                            }
                            else {
                                echo "<td>
                                <a href='/public/list/setBookmark/$list->list_id/0/0' class='btn btn-default' style='font-size:22px;'>&#10032;</a>
                                <a href='/public/list/display/$list->list_id' class='btn btn-success'>View</a>
                                <a href='/public/list/leave/$list->list_id/0' class='btn btn-danger'>Leave</a>
                                </td>";
                            }                                                           
