	...
	<body>
		<div class='container'>
            ...
            <div class='d-flex mb-3'>
				...
				<div class='p-2 flex-fill'>
					<td><a href='/public/friendlink/index' class='btn btn-dark btn-block'>Friends List</a></td>                 
                </div>
                <div class='p-2 flex-fill'>
                    <?php
					...
					<?php 
						if (is_array($data) && !empty($data)) {
							...
							foreach($data['profiles'] as $profile) {
								...
								echo "<div class='flex-fill'><a href='/public/friendlink/remove/$profile->profile_id/3/\"\"' class='btn btn-danger'>Revoke Request</a></div>";
								echo "</div></div>";							
								...
								echo "<a class='dropdown-item' href='/public/friendlink/remove/$profile->profile_id/3/\"\"'>Revoke Request</a>";
								echo "</div></div>";
