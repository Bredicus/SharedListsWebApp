	...
	<body>
		<div class='container'>
            ...
            <div class='d-flex mb-3'>
                ...
                <div class='p-2 flex-fill'>
                    <?php
						$newRequests = $_SESSION['newFriendRequest'];
                        echo "<a href='/public/friendlink/received' class='btn btn-dark btn-block'>Incoming Requests " . 
                        ($newRequests > 0 ? "<span class='badge badge-pill badge-danger'> $newRequests</span>" : "") . "</a>";
                    ?>                
                </div>
                <div class='p-2 flex-fill'>
					...
					<?php 
						if (is_array($data) && !empty($data)) {
							...
							foreach($data['profiles'] as $profile) {
								...
								"' width='35px' heigth='35px' class='rounded-circle'/></td>";
								echo "<td>$profile->first_name $profile->last_name</td/>";
								
								echo "<td><div class='d-none d-sm-block'><div class='d-flex mb-0'>";
								echo "<div class='flex-fill'><a href='/public/profile/display/$profile->profile_id' class='btn btn-info'>View Profile</a></div>";
								echo "<div class='flex-fill'><a href='/public/message/new/$profile->profile_id' class='btn btn-success'>Send Message</a></div>";
								echo "<div class='flex-fill'><a href='/public/friendlink/remove/$profile->profile_id/2/\"\"'' class='btn btn-danger'>Remove Friend</a></div>";
								echo "</div></div>";
								...
								echo "<a class='dropdown-item' href='/public/friendlink/remove/$profile->profile_id/2/\"\"''>Remove Friend</a>";
								echo "</div></div>";
